...
- `AdminController` --inherits--> `Controller`  [EXTRACTED]
  CampRegistrationApp/Controllers/AdminController.cs → CampRegistrationApp.Tests/Tests.cs
- `AssistanceController` --inherits--> `Controller`  [EXTRACTED]
  CampRegistrationApp/Controllers/AssistanceController.cs → CampRegistrationApp.Tests/Tests.cs
- `ComplaintController` --inherits--> `Controller`  [EXTRACTED]
  CampRegistrationApp/Controllers/ComplaintController.cs → CampRegistrationApp.Tests/Tests.cs
- `HomeController` --inherits--> `Controller`  [EXTRACTED]
  CampRegistrationApp/Controllers/HomeController.cs → CampRegistrationApp.Tests/Tests.cs
- `NominationController` --inherits--> `Controller`  [EXTRACTED]
  CampRegistrationApp/Controllers/NominationController.cs → CampRegistrationApp.Tests/Tests.cs
...
Cohesion: 0.07
Nodes (4): By, RegistrationData, RegistrationPage, RegistrationData
...
Cohesion: 0.06
Nodes (32): CampRegistrationApp, net10.0, net10.0, coverlet.collector (6.0.4), Microsoft.AspNetCore.Mvc.Testing (10.0.8), Microsoft.EntityFrameworkCore.InMemory (10.0.8), Microsoft.NET.Test.Sdk (17.14.1), xunit (2.9.3) (+24 more)
...
Cohesion: 0.14
Nodes (16): ApplicationDbContext, HttpGet, HttpPost, IActionResult, IAuditService, IFileCompressionService, IFormFile, INotificationService (+8 more)
...
Cohesion: 0.25
Nodes (6): AssistancePage, AdminDashboardPage, AdminLoginPage, Fact, ITestOutputHelper, AssistanceTests

### Community 24 - "Community 24"
Cohesion: 0.21
Nodes (7): Fact, ITestOutputHelper, RegistrationPage, RecordEditPage, RecordLoginPage, RecordSearchPage, RecordTests
...
Cohesion: 0.21
Nodes (5): AdminDashboardPage, AdminLoginPage, Fact, ITestOutputHelper, AdminAuthAndDashboardTests

### Community 27 - "Community 27"
Cohesion: 0.14
Nodes (10): ApplicationDbContext, IRecordIdGenerator, string, Task, Task, Random, CampRegistrationApp.Services, DummyDataService (+2 more)
...
Cohesion: 0.23
Nodes (8): Task, Exception, HttpContext, IApplicationBuilder, IServiceScopeFactory, ExceptionLoggingMiddleware, ExceptionLoggingMiddlewareExtensions, RequestDelegate

### Community 34 - "Community 34"
Cohesion: 0.20
Nodes (6): ApplicationDbContext, string, Task, IAsyncLifetime, CustomWebApplicationFactory, WebApplication

### Community 35 - "Community 35"
Cohesion: 0.29
Nodes (5): Task, int, FileCompressionService, IFileCompressionService, SKEncodedImageFormat
...
Cohesion: 0.20
Nodes (9): AllowedHosts, ConnectionStrings, DefaultConnection, DummyData, EnableDummyData, Logging, LogLevel, Default (+1 more)

### Community 43 - "Community 43"
Cohesion: 0.27
Nodes (6): ApplicationDbContext, string, Task, CampRegistrationApp.Services, ComplaintIdGenerator, IComplaintIdGenerator

### Community 44 - "Community 44"
Cohesion: 0.27
Nodes (6): ApplicationDbContext, string, Task, CampRegistrationApp.Services, IRecordIdGenerator, RecordIdGenerator

### Community 45 - "Community 45"
Cohesion: 0.20
Nodes (10): 1. التسجيل (عام), TC-1.1: تسجيل عائلة جديدة, TC-1.2: رقم هوية موجود مسبقاً, TC-1.3: التحقق من رقم الهوية (9 أرقام), TC-1.3a: التحقق من خانة التدقيق (Check Digit) لرقم الهوية, TC-1.3b: التحقق من رقم هوية الأم (اختياري), TC-1.3c: منع تكرار أرقام الهوية داخل نفس العائلة, TC-1.3d: منع تكرار رقم هوية الفرد مع رب الأسرة (+2 more)

### Community 47 - "Community 47"
Cohesion: 0.22
Nodes (8): ConnectionStrings, DefaultConnection, DummyData, EnableDummyData, Logging, LogLevel, Default, Microsoft.AspNetCore

### Community 48 - "Community 48"
Cohesion: 0.33
Nodes (3): IWebDriver, WebDriverFactory, Version
...
Cohesion: 0.29
Nodes (7): 11. المشاريع والترشيحات, TC-11.1: إنشاء مشروع جديد, TC-11.2: تعديل مشروع, TC-11.3: إضافة ترشيح لمشروع, TC-11.4: منع تكرار الترشيح, TC-11.5: حذف ترشيح, TC-11.6: إخفاء الإضافة بعد تاريخ النهاية

### Community 58 - "Community 58"
Cohesion: 0.29
Nodes (7): 4. لوحة تحكم المسؤول, TC-4.1: تسجيل دخول المسؤول, TC-4.2: عرض التسجيلات قيد الانتظار, TC-4.3: الموافقة على تسجيل, TC-4.4: رفض تسجيل, TC-4.5: تصفية حسب القاطع, TC-4.6: عرض جميع الحالات
...
Cohesion: 0.29
Nodes (6): CampRegistrationApp.Models.ViewModels, DashboardViewModel, RefugeeListPageViewModel, RefugeeViewModel, RegistrationApprovalViewModel, SectorDashboard

### Community 64 - "Community 64"
Cohesion: 0.33
Nodes (4): TimeSpan, ConcurrentDictionary, IRateLimiterService, RateLimiterService

### Community 65 - "Community 65"
Cohesion: 0.33
Nodes (4): ApplicationDbContext, CampRegistrationApp.Data, DbContext, ModelBuilder
...
Cohesion: 0.40
Nodes (5): 13. تعديل المسؤول للبيانات, TC-13.1: دخول واجهة التعديل, TC-13.2: تعديل وحفظ بيانات العائلة, TC-13.3: تعديل بعد الموافقة (مسموح الآن), TC-13.4: زر التعديل في صفحة التفاصيل

### Community 71 - "Community 71"
Cohesion: 0.40
Nodes (5): 2. تسجيل دخول اللاجئ, TC-2.1: تسجيل الدخول — حساب قيد الانتظار, TC-2.2: تسجيل الدخول — حساب معتمد, TC-2.3: تسجيل الدخول — كلمة مرور خاطئة, TC-2.4: تسجيل الدخول — رقم غير موجود

### Community 72 - "Community 72"
Cohesion: 0.40
Nodes (5): 8. الإشعارات, TC-8.1: إشعار تسجيل جديد للمندوب, TC-8.2: إشعار تعديل بيانات للمندوب, TC-8.3: تحديد إشعار كمقروء, TC-8.4: تحديد الكل كمقروء
...
Cohesion: 0.40
Nodes (4): CampRegistrationApp.Models.ViewModels, MemberViewModel, PersonViewModel, RegistrationViewModel

### Community 76 - "Community 76"
Cohesion: 0.50
Nodes (3): net10.0, Microsoft.NET.Sdk, Microsoft.Data.SqlClient (6.0.2)

### Community 77 - "Community 77"
Cohesion: 0.50
Nodes (3): CampRegistrationApp.Models, CampRegistrationApp.Models.ViewModels, Microsoft.AspNetCore.Http

### Community 80 - "Community 80"
Cohesion: 0.50
Nodes (4): 10. التنقل التسلسلي بين الخطوات, TC-10.1: لا يمكن تخطي الخطوات, TC-10.2: الضغط على الخطوة التالية بعد تعبئة الحقول, TC-10.3: العودة للخلف مسموح دائماً

### Community 81 - "Community 81"
Cohesion: 0.50
Nodes (4): 12. الرغبات (الخطوة 3), TC-12.1: ترتيب الرغبات, TC-12.2: حفظ الرغبات عند العودة للخطوة 3, TC-12.3: إرسال الرغبات مع التسجيل

### Community 82 - "Community 82"
Cohesion: 0.50
Nodes (4): 3. تعديل بيانات العائلة, TC-3.1: تعديل بيانات العائلة, TC-3.2: إضافة فرد جديد, TC-3.3: الدخول للتعديل بدون موافقة

### Community 83 - "Community 83"
Cohesion: 0.50
Nodes (3): NominationPageViewModel, NominationRowViewModel, SectorQuotaInfo
